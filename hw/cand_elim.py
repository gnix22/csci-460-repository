import math
def find_consistent_hypotheses(a_values,b_values,r_values,positive_points,negative_points):
...
def find_maximally_specific(consistent_hypotheses):
    most_specific = []
...
def find_maximally_generic(consistent_hypotheses):
    most_general = []
    for (a1, b1, r1) in consistent_hypotheses:
        is_biggest = True
        for (a2, b2, r2) in consistent_hypotheses:
...
b_values = range(-5, 6)
r_values = range(1, 11)
consistent_hypotheses = find_consistent_hypotheses(a_values, b_values, r_values, positive_points, negative_points)
find_maximally_specific(consistent_hypotheses)
find_maximally_generic(consistent_hypotheses)
